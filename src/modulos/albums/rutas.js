...
router.delete('/:id', eliminate);
 ...
 async function all(req, res){
    try{
        ...
        respuesta.error(req, res, 'We dont have any album', 500);
    }
};
async function uniques(req, res){
    try{
        ...
        respuesta.error(req, res, 'That album isnt registrated', 500);
    }
...
async function actualizar(req,res){
    try{
        ...
        respuesta.success(req, res, 'Album updated successfully', 200);
    }
    catch{
...
async function eliminate(req,res){
    try{
        ...
        respuesta.success(req, res, 'Album eliminated succesfully', 200);
    }
    catch{
